...
<div class="p-3 pb-0">
    <div class="navbar bg-base-200 rounded-box">
        <a href="/" class="btn btn-ghost text-xl gap-2 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-primary" viewBox="0 0 14 14">
        ...
        <div class="dropdown mr-5">
            ...
            <ul class="dropdown-content bg-base-300 w-30 rounded-box z-1 p-2 shadow-2xl">
                <li>
                    <input
                            type="radio"
                            name="theme-dropdown"
